// MSP protocol and bridge implementation for SERV firmware
...
void msp_status_handler(const msp_packet_t* req, msp_packet_t* resp) {
    ...
    memset(resp->payload, 0, 10); // Example: fill with zeros
}
...
#define MSP_RESPONSE_TABLE_SIZE (sizeof(msp_response_table)/sizeof(msp_response_entry_t))
