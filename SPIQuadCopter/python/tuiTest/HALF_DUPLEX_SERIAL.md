...
*Note:* The `wb_ttl_serial` Wishbone wrapper was removed from `src/`. Use the `ttlSerial/` core directly or restore the wrapper from git history if you need the register mapping described previously.
