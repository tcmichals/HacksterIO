 ...
 * Counter increments every clock cycle at 54MHz.
 *
 * Register Map:
 ...
 *
 * Usage:
 *   - Read COUNT_LO for sub-second timing (wraps every ~79 seconds at 54MHz)
 *   - For longer timing, read COUNT_HI:COUNT_LO as 64-bit value
 *   - 54MHz clock: 1 tick = 18.5ns, 54000 ticks = 1ms, 6750 ticks = 125µs (8kHz)
 */
